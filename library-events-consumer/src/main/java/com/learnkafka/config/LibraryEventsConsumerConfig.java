...
public class LibraryEventsConsumerConfig {
    ...
    ConcurrentKafkaListenerContainerFactory<?, ?> kafkaListenerContainerFactory(
        ...
        factory.setErrorHandler(((thrownException, data) -> {
            System.out.println("Exception in consumerConfig is {} and the record is {}"+ thrownException.getMessage()+ data);
            //persist
        }));
            ...
            if(context.getLastThrowable().getCause() instanceof RecoverableDataAccessException){
                ...
                Arrays.asList(context.attributeNames())
                        .forEach(attributeName -> {
                        	...
                        	System.out.println("Attribute Value is : {} "+ context.getAttribute(attributeName));
                });

                ConsumerRecord<Integer, String> consumerRecord = (ConsumerRecord<Integer, String>) context.getAttribute("record");
                libraryEventsService.handleRecovery(consumerRecord);
            }else{
            	System.out.println("Inside the non recoverable logic");
